...
const Employees = () => {
  ...
  const getDetials = async () => {
    const res = await axios.get("https://hrms-software-frontend.onrender.com/getEmployee")
    setuser(res.data)
  }
...
const [formData,setFormData]=useState(tempalete)
  ...
  const submitHandaler=async()=>{
        await axios.post("https://hrms-software-frontend.onrender.com/updateEmployee",formData)
        .then((res)=>{
